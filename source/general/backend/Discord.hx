...
class DiscordClient
{
	...
	private static final _defaultID:String = "1470115231048007784";
			...
			?endTimestamp:Float)
	{
		...
		presence.largeImageText = "Engine Version: " + states.MamainmenuState.psychEngineVersion;
	...
	#if LUA_ALLOWED
	public static function addLuaCallbacks(funk:scripts.lua.FunkinLua)
	{
