...
import games.funkin_legacy.backend.TimingSystem;

import games.funkin_legacy.cutscenes.CutsceneHandler;
...
@:allow(games.funkin_legacy.backend.Replay)
/**
	...
	public function endSong()
	{
		...
		if (ret != LuaUtils.Function_Stop && !transitioning)
		{
			...
			if (!ClientPrefs.data.playOpponent && !replayMode)
			{
				...
				var record:games.funkin_legacy.backend.Replay.StateRecord = {
					songName: songName,
