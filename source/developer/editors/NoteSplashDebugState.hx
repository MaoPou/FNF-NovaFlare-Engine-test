...
class NoteSplashDebugState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.A || virtualPad.buttonUp.justPressed)
			changeSelection(-1);
		else if (FlxG.keys.justPressed.D || virtualPad.buttonDown.justPressed)
			changeSelection(1);
		...
		if (selecArr != null)
		{
			var movex = 0;
			var movey = 0;
			if (FlxG.keys.justPressed.LEFT || virtualPad.buttonLeft2.justPressed)
				movex = -1;
			else if (FlxG.keys.justPressed.RIGHT || virtualPad.buttonRight2.justPressed)
				movex = 1;

			if (FlxG.keys.justPressed.UP || virtualPad.buttonUp2.justPressed)
				movey = 1;
			else if (FlxG.keys.justPressed.DOWN || virtualPad.buttonDown2.justPressed)
				movey = -1;
		...
		if (FlxG.keys.justPressed.SPACE || virtualPad.buttonY.justPressed)
			changeAnim();
		else if (FlxG.keys.justPressed.S || virtualPad.buttonLeft.justPressed)
			changeAnim(-1);
		else if (FlxG.keys.justPressed.W || virtualPad.buttonRight.justPressed)
			changeAnim(1);

		// Force frame
		var updatedFrame:Bool = false;
		if (updatedFrame = FlxG.keys.justPressed.Q || virtualPad.buttonX.justPressed)
			forceFrame--;
		else if (updatedFrame = FlxG.keys.justPressed.E || virtualPad.buttonE.justPressed)
			forceFrame++;
