...
class FlxSoundTray extends Sprite
{
	...
	var _volumeUpSound:FlxSound;
    var _volumeDownSound:FlxSound;
	...
	public function new()
	{
		...
		_volumeUpSound = FlxG.sound.load(FlxAssets.getSound(volumeUpSound));
        _volumeDownSound = FlxG.sound.load(FlxAssets.getSound(volumeDownSound));
	}
